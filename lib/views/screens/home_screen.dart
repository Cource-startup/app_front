import 'package:app_front/views/screens/course_screen.dart';
import 'package:app_front/views/screens/favorite_screen.dart';
import 'package:app_front/views/screens/profile_screen.dart';
import 'package:app_front/views/widgets/custom-footer.dart';
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            Image.asset('assets/images/icons/course_avatar.png',
                                width: 24),
                            Padding(
                      ...
                      Container(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('Active courses', style: AppFonts.courseh3),
                              SizedBox(height: 24),
                              Row(
                                children: [
                                  Text(
                ...
                children: [
                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return CourseCard(); // Ваш кастомный курс
                    },
                  ),
                ],
              ),
